...
static void pausems(uint32_t t); //unicamente para pruebas
...
static uint32_t pausems_count; //unicamente para pruebas


void KEYPAD_init()
{

/*Se configuran los primeros pines como salida y los ultimos como entrada*/
...
/*Entradas. Habilitamos las resistencias pull-up para mantener  un valor logico '1' cuando no se este apretando nada */
...
/*Valor logico 1 a los pines configurados como salida*/
...
/*Unicamente para las pruebas, esto no va.*/
